---
title: NIFD Active Study Page
intro:
  content: |+
    <strong class="ncrad-blue">Welcome NIFD Study staff, coordinators, and PI's.</strong>
  ...
  - title: "Biological Sample and Shipment Notification Forms"
    ...
    actions:
      - text: "Blood Sample Form"
        url: /assets/docs/forms/NCRAD_sample_form_NIFD.doc
        type: download
        external:
