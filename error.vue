<template>
  <NuxtLayout name="default">
    <div class="rvt-bg-black-000 rvt-border-bottom rvt-p-tb-xxl">
      <div class="rvt-container-xl rvt-prose rvt-flow">
        <div class="rvt-row">
          <div class="rvt-cols-12 rvt-text-center">
            <div class="rvt-m-bottom-md rvt-hide-md-down">
              <svg
                width="10%"
                viewBox="0 0 48 48"
                fill="none"
              ...
              >
                ...
                ></path>
                <path
                  d="M19.1899 9.98047L13.8199 15.3505H19.1899V9.98047Z"
                  fill="white"
                ></path>
                <path
            ...
            <h1 class="rvt-m-bottom-md rvt-text-bold rvt-text-uppercase">
              Page not found
            </h1>
            <p class="rvt-ts-18 rvt-color-black-500">
              Sorry, but the page you’re looking for doesn’t exist or was moved.
            </p>
            <Button
              @click="handleError"
              class="rvt-m-top-md"
              variant="primary-btn"
            >
              <rvt-icon name="home-solid" class="rvt-m-right-xs"></rvt-icon>
